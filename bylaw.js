...
let cityBylawLink = (document.getElementsByClassName("city-bylaw-link").href =
  "https://www.edmonton.ca/transportation/Bylaws/C5590.pdf"); // Can expand this functionality as add more cities
let cityBylawName = "Bylaw 5590";
// Edmonton bylaw object
let bylawTextObj = {
  ticketReason1: "parking in an expired meter zone",
  checkBylawsPlainLanguageHint1:
    "Looks like you shouldn't get a ticket if you still have time on the meter, have a permit displayed, or park during the meter's off-hours.",
  ticketBylawExplanation1:
  ...
  ticketReason2:
    "being parked in excess of posted limit in a time restricted zone",
  checkBylawsPlainLanguageHint2:
    "This one is pretty straightforward. You need to stay within the displayed time limit if there is a parking sign nearby.",
  ticketBylawExplanation2:
    "<ul>s(38) <li>A vehicle shall not be parked on a highway in any location identified as a time limited zone for a period of time in excess of the time limit.</li></ul>",

  ticketReason3: "parking outside a metered space",
  checkBylawsPlainLanguageHint3:
    "Looks like in order to avoid a ticket you need to have been parked within the metered space. You should also park as close as possible to the meter.",
  ticketBylawExplanation3:
  ...
  checkBylawsPlainLanguageHint4:
    "You can't park in a closed pay and display zone.",
  ticketBylawExplanation4:
    "<ul>s(46) <li>A vehicle shall not be parked on a highway in any space identified as a pay and display zone when that zone is closed.</li></ul>",
  ...
  checkBylawsPlainLanguageHint6:
    "You can't park within 5 metres of a stop or yield sign unless a traffic sign indicates otherwise.",
  ticketBylawExplanation6:
    "<ul>s(6) <li>Unless a traffic control device permits or requires, a vehicle shall not be parked in the case of an approach to a stop sign or yield sign within 5 metres of the stop sign or yield sign.</li></ul>",
  ...
  checkBylawsPlainLanguageHint8:
    "You can't park or stop within 5 metres of a fire hydrant (or the nearest curb). There is an exception if you are a taxi in a taxi zone and remain in the vehicle.",
  ...
  checkBylawsPlainLanguageHint9:
    "Looks like you can't park within 5 metres of an intersection or 1.5 metres from a private access, driveway, or any other vehicle crossing over a sidewalk unless a sign states otherwise.",
  ticketBylawExplanation9:
  ...
  checkBylawsPlainLanguageHint10:
    "You can't park within 3 metres of the road centre line if the road is at least 12 metres wide.",
  ticketBylawExplanation10:
    "<ul>s(16) <li>A vehicle shall not be parked within 3 metres of the centre line of the roadway on a highway where the roadway portion is 12 metres or more in width.</li></ul>",

  ticketReason11: "parallel parking more than 500mm from the curb",
  checkBylawsPlainLanguageHint11:
    "If you parallel park you need to be within 500mm from the curb and facing the direction of travel.",
  ticketBylawExplanation11:
  ...
  checkBylawsPlainLanguageHint12:
    "You can't park on any part of a sidewalk or boulevard unless a sign states otherwise.",
  ticketBylawExplanation12:
    "<ul>s(4) <li>Unless a traffic control device permits or requires, a vehicle shall not be parked on a sidewalk or boulevard or any part of a sidewalk or boulevard.</li></ul>",

  ticketReason13: "parking in a way that caused an obstruction",
  checkBylawsPlainLanguageHint13:
    "You can't park in a way that blocks traffic, a building's doorway, or anywhere an emergency vehicle needs regular access to such as a hospital, police or fire station.",
  ticketBylawExplanation13:
  ...
  checkBylawsPlainLanguageHint14:
    "Unless you're a bus you can't park in a bus zone. A taxi can stop 6 metres in front of a bus zone if they are loading/unloading passengers.",
  ticketBylawExplanation14:
    "<ul>s(35) <li>(1) Except as permitted in this section a vehicle shall not be stopped on a highway in any location identified as a bus zone unless the vehicle is a bus.</li><li>(2) A taxi may stop in the forward 6 metres of any bus zone while in the process of actually loading or unloading passengers.</li></ul>",

  ticketReason15: "parking in an emergency access zone",
  checkBylawsPlainLanguageHint15:
    "You can't park in a fire lane or any emergency access zone.",
  ticketBylawExplanation15:
    "<ul>s(33) <li>A vehicle shall not be parked on a highway in any location identified as a fire lane, an emergency access zone or otherwise being for the use of emergency vehicles.</li></ul>",

  ticketReason16:
    "parking on a seasonal parking route while a ban was in effect",
  checkBylawsPlainLanguageHint16:
    "You have 8 hours to remove your vehicle from a seasonal parking route once a ban is put in effect.",
  ...
  checkBylawsPlainLanguageHint17:
    "You can't park in a permit zone unless you have a valid permit displayed.",
  ticketBylawExplanation17:
    "<ul>s(37) <li>A vehicle shall not be parked on a highway in any location where a permit to park is required unless a valid and subsisting permit is clearly displayed on the vehicle.</li></ul>",

  ticketReason18: "parking in a disabled zone without a permit",
  checkBylawsPlainLanguageHint18:
    "You can't park in a disabled zone unless you are transporting someone with a disability and have a valid permit/license plate.",
  ticketBylawExplanation18:
  ...
  checkBylawsPlainLanguageHint19:
    "Pretty straight forward. You can't stop anywhere designated as a no stopping zone.",
  ticketBylawExplanation19:
    "<ul>s(31) <li>A vehicle shall not be stopped on a highway in any location identified as a zone where stopping is prohibited.</li></ul>",

  ticketReason20: "parking in a no parking zone",
  checkBylawsPlainLanguageHint20:
    "No surprises here. You can't park anywhere designated as a no-parking zone.",
  ticketBylawExplanation20:
    "<ul>s(30) <li>A vehicle shall not be parked on a highway in any location identified as a zone where parking is prohibited.</li></ul>",

  ticketReason21: "parking in a commercial loading zone",
  checkBylawsPlainLanguageHint21:
    "Unless you're a commerical vehicle, you can't park in a marked commercial loading zone. Commercial vehicles still need to obey any posted time restrictions.",
  ...
  checkBylawsPlainLanguageHint22:
    "You can't stay in a passenger loading zone longer than signage allows.",
  ticketBylawExplanation22:
    "<ul>s(27) <li>A vehicle shall not be parked on a highway in any location identified as a passenger loading zone for a period of time longer than that permitted.</li.</ul>",

  ticketReason23: "parking outside a marked space",
  checkBylawsPlainLanguageHint23:
    "Your vehicle needs to be completely inside the lines when you park in a marked space.",
  ticketBylawExplanation23:
    "<ul>s(14) <li>A vehicle parked on a highway in a location marked by lines or otherwise shall be parked entirely within the markings.</li></ul>",

  ticketReason24: "incorrect angle parking",
  checkBylawsPlainLanguageHint24:
    "Looks like if you are angle parking you need to make sure your front wheels are within 500mm of the front of the stall. Motorcyles can have either wheel within 500mm of the front of the stall so long as they are angled in the direction of travel. If your vehicle is more than 5.8 metres long you can't angle park unless you have a permit or there is signage allowing angle parking.",
  ticketBylawExplanation24:
  ...
  checkBylawsPlainLanguageHint25:
    "You can't leave your vehicle unattended if its on a jack or you are missing a wheel.",
  ticketBylawExplanation25:
    "<ul>s(25) <li>A vehicle shall not be parked and left unattended on a highway if: <br><br>(a) the vehicle is on a jack or a similar device, and <br><br>(b) one or more wheels have been removed from the vehicle or part of the vehicle is raised.</li></ul>",

  ticketReason26: "parking a vehicle that was more than 12.5 metres long",
  checkBylawsPlainLanguageHint26:
    "Unless you have a recreational vehicle or are loading/unloading a commercial vehicle with hazard lights on, you can't park a vehicle longer than 12.5 metres (including trailers) next to residential property. Public roads not adjacent to residential property should be ok unless it is between 7pm-7am.",
  ticketBylawExplanation26:
  ...
  checkBylawsPlainLanguageHint28:
    "You can't park a recreational vehicle on the road unless it's completely adjoining the owner's residence (aka is parked next to your property only) and isn't left for more than 72 hrs. You also need to wait at least 48hrs before re-parking in the same spot.",
  ticketBylawExplanation28:
  ...
  checkBylawsPlainLanguageHint30:
    "You can't double park next to a vehicle unless a sign states otherwise.",
  ticketBylawExplanation30:
    "<ul>s(10) <li>Unless a traffic control device permits or requires, a vehicle shall not be parked on the roadway side of a vehicle that is parked at the curb or edge of the roadway.</li></ul>",

  ticketReason31: "parking in a bridge or tunnel",
  checkBylawsPlainLanguageHint31:
    "You can't park in, or on the approach to, a bridge or tunnel unless a sign states otherwise.",
  ticketBylawExplanation31:
    "<ul>s(9) <li>Unless a traffic control device permits or requires, a vehicle shall not be parked on any bridge or in any tunnel or on any approach to either of them.</li></ul>",
  ...
  checkBylawsPlainLanguageHint33:
    "You need to have a valid ticket or permit displayed while you're in an active pay and display zone. These rules don't apply during the zone's off hours.",
  ticketBylawExplanation33:
  ...
  checkBylawsPlainLanguageHint34:
    "Looks like you can't exceed the paid time remaining as displayed on the traffic control device unless signage indicates off-hours. If your license plate is absent or incorrectly recorded into the EPark device, the court will consider payment was not made unless you are able to prove otherwise.",
  ticketBylawExplanation34:
